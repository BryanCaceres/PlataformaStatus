...
// Class definition
var KTSigninGeneralAdmin = function () {
    // Elements
    var form;
    var submitButton;
    var validator;
    ...
    return {
        // Initialization
        init: function () {
            form = document.querySelector('#kt_sign_in_admin_form');
            submitButton = document.querySelector('#kt_sign_in_admin_submit');
...
KTUtil.onDOMContentLoaded(function () {
    KTSigninGeneralAdmin.init();
});

function onSuccessRecaptchaVerification() {
    var btn = document.querySelector("#kt_sign_in_admin_submit");
...
function onErrorRecaptchaVerification() {
    var btn = document.querySelector("#kt_sign_in_admin_submit");
    var form = document.querySelector("#kt_sign_in_admin_form");
